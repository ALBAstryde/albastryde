...
urlpatterns = patterns('',
    ...
    (r'^admin/precios/bulk_add/$', 'albastryde.admin_bulk_add.views.precios'),
    (r'^admin/precios/bulk_add/(?P<mercado>[^/]+)/(?P<ano>[^/]+)/(?P<mes>[^/]+)/(?P<dia>[^/]+)/$', 'albastryde.admin_bulk_add.views.precios'),
    (r'^admin/lluvia/bulk_add/$', 'albastryde.admin_bulk_add.views.lluvia'),
    (r'^admin/lluvia/bulk_add/(?P<estacion_de_lluvia>[^/]+)/(?P<ano>[^/]+)/(?P<mes>[^/]+)/$', 'albastryde.admin_bulk_add.views.lluvia'),
