...
class Beneficiario(models.Model):
	...
	tamano_de_finca = models.DecimalField(max_digits=6,decimal_places=2, verbose_name="Tamaño de la Finca", help_text="Introduzca el tamaño de la finca", blank=True, null=True)
	altura_promedio = models.DecimalField(max_digits=6,decimal_places=2, verbose_name="Altura promedio", blank=True, null=True)
	area_de_produccion = models.DecimalField(max_digits=6,decimal_places=2, verbose_name="Area de produccion", blank=True, null=True)
	area_en_desarollo = models.DecimalField(max_digits=6,decimal_places=2, verbose_name="Area en desarrollo", blank=True, null=True)
	rendimiento_promedio_en_qq = models.DecimalField(max_digits=6,decimal_places=2, verbose_name="Rendimiento promedio en QQ", blank=True, null=True)
	rendimiento_promedio_en_oro = models.DecimalField(max_digits=6,decimal_places=2, verbose_name="Rendimiento promedio en ORO", blank=True, null=True)
